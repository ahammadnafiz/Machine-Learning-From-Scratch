...
- Deep learning is taking off for 3 reasons:
  ...
  3. Algorithm:
     1. Creative algorithms has appeared that changed the way NN works.
        - For example using RELU function is so much better than using SIGMOID function in training a NN because it helps with the vanishing gradient problem.[[Comparison of ReLU and Sigmoid Activation Functions]]
